...
export const content = {
  ...
  vibes: {
    ...
    presets: [
      ...
      { id: "night", label: "Night Sky", mood: "midnight · starlit · calm", dark: true,
        accent: "#8fb2ff", accent2: "#c9a3ff", plasma: ["#5c7cfa", "#8fb2ff", "#c9a3ff"], particle: "#8fb2ff",
        bg: "#080c1c", bgTint: "#0d1226", surface: "#121834", surface2: "#171e40",
        ink: "#e8ecff", inkDim: "#a9b4e0", inkMute: "#6b76a8",
        line: "rgba(160,180,255,.14)", lineStrong: "rgba(160,180,255,.24)",
        font: '"Geist", ui-sans-serif, system-ui, -apple-system, "Helvetica Neue", sans-serif', background: "starfield", radius: "14px" },
